# -*- coding: utf-8 -*-
"""(중급) 12차시_프로젝트 4 제출코드.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1iwLXb2_BmVnIYd-U4NcUdmGiWNnIE-qf
...
# CSV 파일로 저장
result_df.to_csv(my_submission_path, index=False)
...
print(120814.62495)  # ... 에 점수를 기록해주세요.
