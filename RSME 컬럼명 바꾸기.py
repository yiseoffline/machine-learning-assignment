# -*- coding: utf-8 -*-
"""(중급) 13차시_프로젝트 5 제출코드.ipynb의 사본

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1eg_vTehDMpGCFGOne7LFSvBpRGuihycm
...
results['RMSLE'] = results.pop('RMSE')
results
## 코드종료 ##
...
results = results = results.sort_values('RMSLE')results
